...
This skill generates high-performing Substack notes by applying proven structural patterns and psychological techniques while maintaining YOUR unique voice through context profiles.
...
Before generating any note, you MUST load context profiles provided in the task.

These profiles ensure the note sounds like the USER, not like someone else.

### Step 2: Analyze Input & Choose Note Type
...
### Step 4: Generate Note with Voice Integration

**Critical Requirements:**
1. **Use the STRUCTURE** from the formula
2. **Apply USER'S VOICE** from context profiles
3. **Include SPECIFIC DETAILS** from business profile when relevant
4. **Match the PSYCHOLOGY** of the note type
5. **Follow the LENGTH** guideline for the type

**Voice Application Checklist:**
- [ ] Sentence rhythms match voice patterns
- [ ] Uses user's signature phrases naturally
- [ ] Matches their emotional palette
- [ ] Applies their conviction patterns appropriately
- [ ] Uses their natural transitional habits
...
1. **Load context profiles** provided in the task
2. **Analyze input & choose note type** (which of the 10 fits best?)
3. **Apply formula** (use the structural pattern)
4. **Write in user's voice** (structure + their unique voice)
5. **Format & deliver** (clean, formatted, ready to post)

## Final Notes

**Remember:** This skill gives you proven structures and psychology that work on Substack. Context profiles ensure you sound like yourself, not like someone else.

**The magic:** Structure is universal. Voice is unique. This skill combines both.
